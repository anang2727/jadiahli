    ...
    <section className="max-w-7xl mx-auto px-6 pt-14 pb-16 grid lg:grid-cols-2 gap-14 items-center">
      <div>
        ...
        <h1 className="text-4xl sm:text-5xl font-extrabold leading-[1.15] tracking-tight text-slate-900">
          Belajar melalui{" "}
          <span className="text-primary">video</span>, sekali bayar untuk
          akses <span className="text-primary">selamanya</span>
        </h1>
      ...
      <div className="relative">
        <div className="absolute -top-6 -left-4 z-20 w-14 h-14 rounded-2xl bg-slate-900 flex items-center justify-center text-secondary-foreground shadow-lg rotate-[-8deg]">
          <Boxes className="w-6 h-6" />
        </div>
        <div className="absolute -top-4 -right-4 z-20 w-14 h-14 rounded-2xl bg-white flex items-center justify-center text-secondary-foreground shadow-lg rotate-[8deg]">
          <Code2 className="w-6 h-6" />
        </div>

        <div className="h-80 sm:h-96 rounded-[2rem] bg-linear-to-br from-teal-500 via-teal-600 to-blue-900 flex items-center justify-center shadow-xl">
        ...
        <div className="absolute -bottom-6 left-6 right-6 sm:left-10 sm:right-auto z-20 bg-white rounded-2xl shadow-xl border border-slate-100 px-4 py-3 flex items-center gap-3 max-w-xs">
          <div className="w-14 h-10 rounded-lg bg-linear-to-br from-blue-500 to-slate-900 shrink-0" />
          <div>
